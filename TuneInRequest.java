...
public class TuneInRequest {
    ...
    private final static int e_TUNEIN_RESPONSE_TYPE_XML = 0;
    private final static int e_TUNEIN_RESPONSE_TYPE_URL = 1;
...
//    private final static int e_Request_Browse_Index = 0;
//    private final static int e_Request_Browse_Local = 1;
//    private final static int e_Request_Browse_Presets = 2;
//    private final static int e_Request_Browse_Category = 3;
//    private final static int e_Request_Browse_Language = 4;
//    private final static int e_Request_Browse_Station = 5;
//    private final static int e_Request_Browse_Station_Schedules = 6;
//    private final static int e_Request_Browse_Station_Playlist = 7;
//    private final static int e_Request_Browse_Show = 8;
//    private final static int e_Request_Config_Time = 9;
//    private final static int e_Request_Config_Localized_Strings = 10;
//    private final static int e_Request_Config_Sample_Stream = 11;
//    private final static int e_Request_Describe_NowPlaying = 12;
//    private final static int e_Request_Describe_Station = 13;
//    private final static int e_Request_Describe_Show = 14;
//    private final static int e_Request_Describe_Topic = 15;
//    private final static int e_Request_Describe_Countries = 16;
//    private final static int e_Request_Describe_Languages = 17;
//    private final static int e_Request_Describe_Locales = 18;
//    private final static int e_Request_Describe_Formats = 19;
//    private final static int e_Request_Describe_Genres = 20;
//    private final static int e_Request_Options = 21;
//    private final static int e_Request_Preset_Add = 22;
//    private final static int e_Request_Preset_Remove = 23;
//    private final static int e_Request_Preset_AddFolder = 24;
//    private final static int e_Request_Preset_RemoveFolder = 25;
//    private final static int e_Request_Preset_RenameFolder = 26;
//    private final static int e_Request_Preset_ListFolder = 27;
//    private final static int e_Request_Recommend_StationByArtist = 28;
//    private final static int e_Request_Report_Wizard = 29;
//    private final static int e_Request_Report_Feedback = 30;
//    private final static int e_Request_Report_Stream = 31;
//    private final static int e_Request_Search = 32;
//    private final static int e_Request_Search_Artists = 33;
//    private final static int e_Request_Search_Songs = 34;
//    private final static int e_Request_Search_Artist_Song = 35;
//    private final static int e_Request_Search_Stream = 36;
//    private final static int e_Request_Tune_Station = 37;
//    private final static int e_Request_Tune_Show = 38;
    ...
    HashMap<String, tuneInLink> mLinkList = new HashMap<String, tuneInLink>();

    public class tuneInOutlineElement {
        String type;
        String text;
        String url;
        int bitrate;
    ...
    HashMap<String, tuneInOutlineElement> mStationList = new HashMap<String, tuneInOutlineElement>();
    HashMap<String, tuneInOutlineElement> mShowList = new HashMap<String, tuneInOutlineElement>();
    HashMap<String, tuneInOutlineElement> mTopicList = new HashMap<String, tuneInOutlineElement>();
    ...
    private void addLink(XmlPullParser p) {
        ...
        mLinkList.put(link.getKey(), link);
    }

    private void addStation(XmlPullParser p, HashMap<String, tuneInOutlineElement> list) {
        tuneInOutlineElement station;
        ...
        station = new tuneInOutlineElement();
        for (int i = 0; i < num; i++) {
            attributeName = p.getAttributeName(i);
            if (attributeName.equals("type")) {
        ...
        list.put(station.getGuide_id(), station);
    }
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Log.e(LogTag, "Response Len is :::" + response.toString().length());

            switch (msg.what) {
                case e_TUNEIN_RESPONSE_TYPE_XML:
                    try {
                            ...
                            switch (eventType) {
                                ...
                                case XmlPullParser.START_TAG:
                                    ...
                                    if (tag.equals("outline")) {// outline tag
                                        ...
                                        if (3 == depth) {//top outline, judge sequence type->item
                                            ...
                                            if (null != element_type
                                                ...
                                                //audio station
                                                addStation(parser, mStationList);
                                            } else if (null != element_type
                                                    && element_type.equals("audio")
                                                    && null != element_guide_id
                                                    && is_show_id(element_guide_id)) {
                                                //show station
                                                addStation(parser, mShowList);
                                            } else if (null != element_type
                                                    && element_type.equals("audio")
                                                    && null != element_guide_id
                                                    && is_topic_id(element_guide_id)) {
                                                //topic station
                                                addStation(parser, mTopicList);
                                            } else if (null != element_type
...
//                                        if (null != element_type && element_type.equals("link")) {
//                                            //link type
//                                            addLink(parser);
//                                        } else if (null != element_type && element_type.equals("audio")) {
//                                            //audio type
//                                            String guide_id = parser.getAttributeValue(null, "guide_id");
//                                            if (is_station_id(guide_id))//Station
//                                                addStation(parser, mStationList);
//                                            else if (is_show_id(guide_id))//Show
//                                                addStation(parser, mShowList);
//                                            else if (is_topic_id(guide_id))//Topic
//                                                addStation(parser, mTopicList);
//                                            else
//                                                Log.e(LogTag, "Un-classify audio item: " + parser.toString());
//                                        } else if (null != element_item && element_item.equals("show")) {
//                                            //Show Item
//                                            addStation(parser, mShowList);
//                                        } else if (null != element_item && element_item.equals("station")){
//                                            //Station Item
//                                            addStation(parser, mStationList);
//                                        }
                                    }
                        ...
                        Log.e(LogTag, "Finish XML parse");
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                    break;

                case e_TUNEIN_RESPONSE_TYPE_URL:
                    break;
            ...
            public void run() {
                ...
                try {
                    ...
                    if(200 == httpResponse.getStatusLine().getStatusCode()){
                        ...
                        Log.e(LogTag, "Response LEN :::" + entity.getContentLength());
                        BufferedReader reader = new BufferedReader(new InputStreamReader(entity.getContent()));
                        StringBuffer buffer = new StringBuffer();
                        while ((line = reader.readLine()) != null) {
                            Log.e(LogTag, "Response :::" + line);
                            buffer.append(line);
                        }
                        reader.close();
...
//    }
    ...
    public int radioTimeBrowseIndex(){
        ...
        sendRequestWithHttpClient(requestStr, e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeBrowseLocal(String userName, String latlon, String formats) {
        ...
        sendRequestWithHttpClient(getTuneInURL("Browse", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeBrowsePresets(String userName, String formats) {
        ...
        sendRequestWithHttpClient(getTuneInURL("Browse", param, needSerial), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
     ...
     *  his method makes it possible to browse this content.
     *
     * Input:
    ...
    public int radioTimeConfigTime() {
        ...
        sendRequestWithHttpClient(getTuneInURL("Config", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeDescribeNowPlaying(String id) {
        ...
        sendRequestWithHttpClient(getTuneInURL("Describe", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeOptions(String id) {
        ...
        sendRequestWithHttpClient(getTuneInURL("Options", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    ...
    public int radioTimePresetAdd(String userName, String password, String folderId, String id
        ...
        sendRequestWithHttpClient(getTuneInURL("Preset", param, needSerial), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeRecommendStationByArtist(String artist, String recommend) {
        ...
        sendRequestWithHttpClient(getTuneInURL("Recommend", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeReportWizard(String id, String email) {
        ...
        sendRequestWithHttpClient(getTuneInURL("Report", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeSearch(String query, String filter, String types
        ...
        sendRequestWithHttpClient(getTuneInURL("Search", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
    ...
    public int radioTimeTuneStation(String id, boolean ebrowse){
        ...
        sendRequestWithHttpClient(getTuneInURL("Tune", param, true), e_TUNEIN_RESPONSE_TYPE_XML);
        return 0;
    }
